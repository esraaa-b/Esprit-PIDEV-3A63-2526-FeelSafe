 ...
 */
final class Version20260228200851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE parent_id parent_id INT NOT NULL, CHANGE date_commentaire date_commentaire DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE reported_at reported_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY FK_67F068BC38B217A7');
        $this->addSql('ALTER TABLE commentaire CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE date_commentaire date_commentaire DATETIME DEFAULT NULL, CHANGE reported_at reported_at DATETIME DEFAULT NULL');
