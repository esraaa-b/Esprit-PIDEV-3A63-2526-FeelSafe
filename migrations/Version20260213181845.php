 ...
 */
final class Version20260213181845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accompagnement (id_accompagnement INT AUTO_INCREMENT NOT NULL, id_rendez_vous INT DEFAULT NULL, id_utilisateur INT DEFAULT NULL, prochain_rdv VARCHAR(5) NOT NULL, date_prochain_rdv DATE DEFAULT NULL, objectifs LONGTEXT DEFAULT NULL, notes_suivi LONGTEXT DEFAULT NULL, niveau_priorite SMALLINT DEFAULT NULL, INDEX IDX_2130A05B7DFA67FD (id_rendez_vous), INDEX IDX_2130A05B50EAE44 (id_utilisateur), PRIMARY KEY(id_accompagnement)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, publication_id INT NOT NULL, user_id INT NOT NULL, contenu LONGTEXT NOT NULL, date_commentaire DATETIME DEFAULT NULL, INDEX IDX_67F068BC38B217A7 (publication_id), INDEX IDX_67F068BCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE password_reset_token (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, token VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_used TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_6B7BA4B65F37A13B (token), INDEX IDX_6B7BA4B6A76ED395 (user_id), INDEX idx_token (token), INDEX idx_expires_at (expires_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, date_publication DATETIME DEFAULT NULL, INDEX IDX_AF3C6779A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rendez_vous (id_rendez_vous INT AUTO_INCREMENT NOT NULL, id_utilisateur INT DEFAULT NULL, id_professionnel INT DEFAULT NULL, date_rdv DATE NOT NULL, heure_rdv TIME NOT NULL, mode VARCHAR(20) NOT NULL, localisation VARCHAR(255) DEFAULT NULL, statut VARCHAR(20) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, INDEX IDX_65E8AA0A50EAE44 (id_utilisateur), INDEX IDX_65E8AA0AC400106A (id_professionnel), PRIMARY KEY(id_rendez_vous)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, role JSON NOT NULL COMMENT \'(DC2Type:json)\', mot_de_passe VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, statut VARCHAR(20) NOT NULL, date_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
