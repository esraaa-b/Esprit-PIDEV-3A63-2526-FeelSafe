...
class SecurityController extends BaseDashboardController
{
    ...
    public function updatePrivacy(Request $request): Response
    {
        ...
        try {
            // Checkboxes: value is 'on' when checked, null when unchecked
            ...
            // Select: value is 'prive' or 'public' directly
            $visibilite = $request->request->get('visibilite_profil', 'prive');
            $confidentialite->setVisibiliteProfil(in_array($visibilite, ['public', 'prive']) ? $visibilite : 'prive');
