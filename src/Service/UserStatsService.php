...
class UserStatsService
{
     ...
     */
    private function getActiveDays(Utilisateur $user): int
    {
     ...
     */
    private function getJournalCount(Utilisateur $user): string
    {
     ...
     */
    private function getPracticeTime(Utilisateur $user): string
    {
     ...
     */
    private function getCurrentStreak(Utilisateur $user): string
    {
        // TODO: Implémenter selon votre logique métier
     ...
     */
    private function calculateWellbeingScore(Utilisateur $user): int
    {
        // TODO: Implémenter selon votre logique métier
     ...
     */
    private function getBestStreak(Utilisateur $user): int
    {
        // TODO: Implémenter selon votre logique métier
        return 21;
    }
     ...
     */
    private function getCommunityRank(Utilisateur $user): int
    {
        // TODO: Implémenter selon votre logique métier
