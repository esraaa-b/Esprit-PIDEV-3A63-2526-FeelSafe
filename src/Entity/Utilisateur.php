...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, ActiviteBienEtre>
     */
    #[ORM\OneToMany(targetEntity: ActiviteBienEtre::class, mappedBy: 'creePar')]
    private Collection $activitesCrees;

    /**
     * @var Collection<int, SessionActivite>
     */
    #[ORM\OneToMany(targetEntity: SessionActivite::class, mappedBy: 'utilisateur')]
    ...
    /**
     * @return Collection<int, ActiviteBienEtre>
     */
    ...
    public function addActivitesCree(ActiviteBienEtre $activitesCree): static
    {
        if (!$this->activitesCrees->contains($activitesCree)) {
            $this->activitesCrees->add($activitesCree);
            $activitesCree->setCreePar($this);
        }
        return $this;
    }

    public function removeActivitesCree(ActiviteBienEtre $activitesCree): static
    {
        if ($this->activitesCrees->removeElement($activitesCree)) {
            if ($activitesCree->getCreePar() === $this) {
                $activitesCree->setCreePar(null);
            }
        }
        return $this;
    }
    ...
    public function addSessionsActivite(SessionActivite $sessionsActivite): static
    {
        if (!$this->sessionsActivites->contains($sessionsActivite)) {
            $this->sessionsActivites->add($sessionsActivite);
            $sessionsActivite->setUtilisateur($this);
        }
        return $this;
    }

    public function removeSessionsActivite(SessionActivite $sessionsActivite): static
    {
        if ($this->sessionsActivites->removeElement($sessionsActivite)) {
            if ($sessionsActivite->getUtilisateur() === $this) {
                $sessionsActivite->setUtilisateur(null);
            }
        }
        return $this;
    }
